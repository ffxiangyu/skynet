...
linux_world :
	$(MAKE) $(WORLD_PATH)/s_world PLAT=$@ SKYNET_LIBS="$(SKYNET_LIBS) -lstdc++ -std=c++11" SHARED="$(SHARED)" EXPORT="$(EXPORT)" MALLOC_STATICLIB="$(MALLOC_STATICLIB)" SKYNET_DEFINES="$(SKYNET_DEFINES)"
